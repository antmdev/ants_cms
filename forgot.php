           ...
           if(isset($_POST['email'])) {
               ...
               if(useremail_exists($email)){
                   ...
                   if($stmt = mysqli_prepare($connection, "UPDATE users SET token='{$token}' WHERE user_email= ?")){
                       ...
                       $mail->SMTPAuth = true;
                       $mail->isHTML(true);
                       $mail->CharSet = 'UTF-8'; // fixes issues with non-UK characters
    
    
                       $mail->setFrom('antmilner@hotmail.com', 'Ant Milner');
                       ...
                       // send to a page on your site / enter a parameter / concatinate email variable
